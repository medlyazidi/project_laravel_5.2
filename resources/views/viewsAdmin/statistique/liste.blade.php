...
@section('head')
    <div class="col-sm-12" dir="rtl">
        <h3>{!! $titre_depute_stat !!} {{ app('request')->input('date_recherche_fin') }}</h3>
        <ol class="breadcrumb">
            <li>
                <a href="{!! route('menu_img') !!}">{!! $accueil !!} </a>
            </li>
            <li class="active">
                <strong>{!! $sous_titre_stat_depu !!}</strong>
            </li>
        </ol>
    </div>
@endsection
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                @foreach($listDeputeMondats as $item)
                                    <?php
                                        ...
                                        $cts_att_annee_crt_1 +=$item->cts_att_annee_crt;
                                ...
                                <tr  dir="ltr">
                                    ...
                                    <td>{!! number_format($cts_att_annee_crt_1,2,",","")  !!}</td>
